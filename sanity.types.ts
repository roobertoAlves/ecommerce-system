...
// Variable: query
// Query: *[  _type == "product" && (    $tab == "all" ||    count((categories[]->slug.current)[@ in $categorySlugs]) > 0  )] | order(name asc) { ...,"categories": categories[]->title }
...
declare module "@sanity/client" {
  interface SanityQueries {
    '*[\n  _type == "product" && (\n    $tab == "all" ||\n    count((categories[]->slug.current)[@ in $categorySlugs]) > 0\n  )\n] | order(name asc) { ...,"categories": categories[]->title }': QueryResult;
